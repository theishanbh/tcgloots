  ...
  return (
    <div className="flex flex-col content-between from-zinc-300 ">
      ...
      <div className="relative m-2 space-y-2 xl:hidden">
        {post ? (
          <InstoreAddPost setPost={setPost} />
        ) : showdes ? (
          <InstoreCardDescription setShowdes={setShowdes} />
        ) : (
          <>
            <div className="flex justify-between mx-4 mt-4 flex-row mb-4">
              <div className="flex-col mb-4">
                <div className="font-jost text-lg text-black-100">
                  Instore Finds
                </div>
                <div className="font-jost text-sm text-grey-200">
                  Feb 16, 2022
                </div>
              </div>
              <div>
                <button
                  ...
                  className="bg-blue-300 mt-1 w-24 h-8  flex flex-row space-x-2 justify-center  font-jost text-sm text-white-100 rounded-md"
                >
                  <div className="">
                    <Image
        ...
        <div className="w-2/3 h-full flex flex-col mx-24  justify-center pt-4">
          <div className="flex  flex-1 items-center justify-between flex-row space-x-4">
            <div className="flex-col flex flex-3">
              <div className="font-jost text-8xl text-black-100">
                Instore Finds
              </div>
              <div className="font-jost text-xl text-grey-200">
                Feb 16, 2022
              </div>
            </div>

            ...
            <div className="bg-[url('/assets/giveaways/background.png')] bg-contain bg-no-repeat">
              <div className='mx-auto max-w-7xl font-jost'>
                ...
                <div className='flex flex-col font-jost'>
                  <h1 className='text-center text-black-200 text-8xl font-semibold pt-20'>Giveaways</h1>
                    ...
                    <div className="">
                      <div className="flex flex-col bg-white-100 shadow-full border border-grey-600 p-4 rounded-lg">
                        ...
                        <div className="flex justify-between items-center">
                          ...
                          <button className='border font-jost text-white-100 bg-yellow-200 text-base font-medium rounded-md px-12 py-2 ml-2'>ENTER</button>
                        </div>
                      </div>
                    </div>
                    <div className="">
                        ...
                        <div className="flex flex-col opacity-50">
                          ...
                          <div className="flex justify-between items-center">
                            <span className='flex items-center'>
                              <span className="text-xl text-grey-400 pr-3">ENDED </span> 

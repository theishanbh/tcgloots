    ...
    <div className=" bg-slate-500">
      <div className="max-w-7xl mx-auto font-jost py-12">
        <div className="flex flex-col justify-center items-center">
          <h1 className=" font-jost text-8xl text-black-200 font-semibold text-center pb-12">
            Streamers We Support
          </h1>
          {/* featured streamer */}
          <div className="flex flex-col items-center">
            <div className="flex justify-center items-center">
              ...
              <span className="px-4 text-2xl font-medium text-black-100">
                Cameron Williamson
              </span>
          ...
          <div className="relative py-24 w-full bg-[url('/assets/homepage/streamerswesupport/background.png')] bg-cover">
            <div className="flex items-center md:justify-between px-4 bg-slate-400 bg-opacity-70 py-4 overflow-x-scroll lg:overflow-x-hidden">
              <div className="flex flex-col px-8 shrink-0 items-center ">
                ...
                <span className=" text-base font-light text-black-100">
                  58 K
                </span>
              </div>
              <div className="flex flex-col px-8 shrink-0 items-center">

...
const ProductTracker = () =>{
    ...
    return(
        <div className="font-jost">
            <div className="bg-colors-grey-600">
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="flex flex-wrap">
                        <div className="w-1/6">
                            <div className=" bg-colors-white h-4/5 p-4 ">
            ...
            <div className="bg-colors-grey-700">
                <div className="max-w-7xl mx-auto py-8">
                    ...
                    <div className="text-center">
                        ...
                        <button className=" bg-colors-blue-primary text-colors-white inline-flex hover:bg-colors-blue-100 mt-6 text-white font-bold py-2 px-4 rounded"> Submit a suggestion <img src="./assets/rightarrow.svg" className="ml-2"/> </button>
                    </div>
                </div>
            </div>                
        </div>

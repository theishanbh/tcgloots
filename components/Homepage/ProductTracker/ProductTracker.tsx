        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex flex-wrap">
            <div className=" w-1/2 mob:w-1/3 lg:w-1/6">
              ...
              <p className=" text-lg text-black-100 text-center h-1/5">
                Lorem, ipsum dolor
              </p>
            </div>
            <div className=" w-1/2 mob:w-1/3 lg:w-1/6">
            ...
            <div className=" hidden lg:block w-1/6">
              <div className=" bg-white h-4/5 p-4 ">
                <img
                  ...
                  alt=""
                  className="h-full w-full p-2 shadow-full rounded-lg"
                />
              </div>
              <p className=" text-lg text-black-100 text-center h-1/5">
                Lorem, ipsum dolor
        ...
        <div className="max-w-7xl mx-auto py-8">
          ...
          <div className="flex items-center justify-center">
            ...
            <div className="text-center px-4 md:px-12">
              <p className=" text-left md:text-center text-base sm:text-lg md:text-4xl font-light">
                Want to suggest a product for us to track?
              </p>

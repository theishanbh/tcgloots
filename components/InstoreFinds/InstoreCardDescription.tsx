...
export default function InstoreCardDescription(props: props) {
    return (
        <div className='flex-1 flex-col flex mx-4 my-6' onClick={()=>props.setShowdes(false)}>
          ...
          <div className='flex-1 flex flex-row mx-2 space-x-10'>
          ...
          <div className='flex-1 flex flex-col mx-2 mb-2'>

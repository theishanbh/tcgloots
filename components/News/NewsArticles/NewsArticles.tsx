  ...
  return (
    <div>
        <div className=' max-w-7xl mx-auto font-jost py-8'>
            {/* Categories */}
            <div className=' bg-white shadow-lg p-4 border-4 rounded-lg border-grey-500'>
                <div className='flex'>
            ...
            <section className="bg-white pt-1">
              <div className="flex flex-col md:flex-row lg:flex-row xl:flex-row py-12 mx-auto max-w-xl md:max-w-3xl lg:max-w-5xl xl:max-w-6xl px-4 xl:px-0">
                  <div className="flex flex-col-reverse flex-3 mr-8">
                    <div className="flex flex-col items-center md:items-start lg:items-start xl:items-start sm:flex-col md:flex-row lg:flex-row justify-start border-solid border-b-2 border-grey-primary py-10" >
                        <div 
                        ...
                        <div className="flex flex-col h-full ml-4 w-auto">
                            ...
                            <div className="text-xl text-black-200 text-center md:text-left lg:text-left xl:text-left overflow-ellipsis overflow-hidden whitespace-nowrap"> Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do... </div>
                            <div className=" text-base text-black-200 text-center mt-auto md:text-left lg:text-left xl:text-left italic pt-3"> 1 Dec 2021 </div>
                        </div>
                      </div>
                    </div>
              </div>
